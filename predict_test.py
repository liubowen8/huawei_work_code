...
def main():
    ...
    weights = "weights/yolov3spp-499.pt"  # 改成自己训练好的权重文件
    json_path = "./data/soda_classes.json"  # json标签文件
    img_path = "/home3/hqlab/liubowen/code/deep-learning-for-image-processing/pytorch_object_detection/yolov3_spp/my_soda_yolo_dataset/val/images/HT_VAL_004972_SZ_000.jpg"
    ...
    with torch.no_grad():
        ...
        fms=[]
        pred = model(img, fms)[0]  # only get inference result
